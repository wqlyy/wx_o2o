import My from './indel.model.js';
import Address from '../../utils/address.js';
import Order from '../order/index.model.js';
...
Page({
  ...
  onShow(){
    let newOrderFlag = order.hasNewOrder()
  ...
  showOrderDetailInfo: function (event) {
    ...
    wx.navigateTo({
      url: '../order/index?from=order&id=' + id
    });
  },
  ...
  _execPay: function (id, index) {
    ...
    order.execPay(id, (statusCode) => {
      if (statusCode > 0) {
        ...
        //跳转到 成功页面
        wx.navigateTo({
          url: '../pay-result/index?id=' + id + '&flag=' + flag + '&from=my'
        });
      } else {
